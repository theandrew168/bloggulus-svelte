<section>
	...
	<p>Last updated: October 20, 2024</p>
	<p>
	...
	<ul>
		...
		<li>
			<p>
				...
				in this Agreement) refers to Bloggulus.
			</p>
		</li>
		<li>
			<p>
		...
		<li>
			<p>
				<strong>Website</strong> refers to Bloggulus, accessible from
				<a href="https://bloggulus.com" rel="external nofollow noopener" target="_blank">https://bloggulus.com</a>
			</p>
		</li>
		<li>
			<p>
	...
	<p>
		...
		Personal data that is already associated with Your Third-Party Social Media Service's account, such as Your user ID,
		Your name, or Your email address.
	</p>
	<h4>Tracking Technologies and Cookies</h4>
	<p>
		We use Cookies to track the activity on Our Service and store certain information. The technologies We use may
		include:
	</p>
	<ul>
		<li>
	...
	<ul>
		<li>By email: andrew@shallowbrooksoftware.com</li>
	</ul>
</section>
